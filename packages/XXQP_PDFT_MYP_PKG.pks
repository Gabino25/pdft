CREATE OR REPLACE package APPS.xxqp_pdft_myp_pkg is 
...
/** 03052021 se filtra nombre de cliente tambien por numeros **/
...
type rep_info_typ is record (
   ...
   ,PRECIO_CD                           XXQP_PDFT_REPORTES_V.PRECIO_CD%TYPE
   ,PRECIO_PROTON_CD             XXQP_PDFT_REPORTES_V.PRECIO_PROTON_CD%TYPE
);
