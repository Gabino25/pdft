package xxqp.oracle.apps.ar.pdft.ss.schema.server;
...
public class XxqpPdftUsuariosRoEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxqp.oracle.apps.ar.pdft.ss.schema.server.XxqpPdftUsuariosRoEO");
        }
