...
// ---------------------------------------------------------------------
public class OperatingUnitVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public OperatingUnitVOImpl() {
    }

    void initByLegalEntityID(Number pNumLegalEntity) {
        ...
        vcr1.setAttribute("LegalEntityId",pNumLegalEntity); 
