...
// ---------------------------------------------------------------------
public class XxqpPdftMgrCatalogosVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public XxqpPdftMgrCatalogosVOImpl() {
    }

    void initByCatalogoValue(String pStrCatalogoValue) {
        ...
        vcr1.setAttribute("LookupType",pStrCatalogoValue); 
