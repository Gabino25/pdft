...
// ---------------------------------------------------------------------
public class XxqpPdftBpoRequeAdicioAdquVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public XxqpPdftBpoRequeAdicioAdquVOImpl() {
    }

    void initByBpoHeaderId(Number pNumBpoHeaderId) {
        ...
        vcr1.setAttribute("BpoHeaderId",pNumBpoHeaderId); 
