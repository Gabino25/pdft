...
// ---------------------------------------------------------------------
public class XxqpPdftBpoRegNegVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public XxqpPdftBpoRegNegVOImpl() {
    }

    void initByBpoHeaderId(Number numBpoHeaderId){
        ...
        vcr1.setAttribute("BpoHeaderId",numBpoHeaderId); 
