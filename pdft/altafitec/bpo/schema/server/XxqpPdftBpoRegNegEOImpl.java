...
// ---------------------------------------------------------------------
public class XxqpPdftBpoRegNegEOImpl extends OAEntityImpl {
    ...
    public static final int XXQPPDFTBPOHEADEREO = 16;
     ...
     */
    public XxqpPdftBpoRegNegEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("xxqp.oracle.apps.ar.pdft.altafitec.bpo.schema.server.XxqpPdftBpoRegNegEO");
        }
