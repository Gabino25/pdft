...
import xxqp.oracle.apps.ar.pdft.altafitec.masiplat.schema.server.XxqpPdftMypProcesosEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxqpPdftMypComentsProcesosVORowImpl extends OAViewRowImpl {
     ...
     */
    public XxqpPdftMypComentsProcesosVORowImpl() {
    }

    /**Gets XxqpPdftMypProcesosEO entity object.
     */
    public XxqpPdftMypProcesosEOImpl getXxqpPdftMypProcesosEO() {
        return (XxqpPdftMypProcesosEOImpl)getEntity(0);
    }
    ...
    /**Sets <code>value</code> as attribute value for PROSESO using the alias name Proseso
     */
    public void setProseso(String value) {
        setAttributeInternal(PROSESO, value);
    }

    /**Gets the attribute value for OTROS_PROCESOS using the alias name OtrosProcesos
     */
    public String getOtrosProcesos() {
        return (String) getAttributeInternal(OTROSPROCESOS);
    }

    /**Sets <code>value</code> as attribute value for OTROS_PROCESOS using the alias name OtrosProcesos
     */
    ...
    /**Sets <code>value</code> as attribute value for SELECCIONAR using the alias name Seleccionar
     */
    ...
    /**Gets the attribute value for COMENTARIOS_INSTRUCC using the alias name ComentariosInstrucc
     */
    public String getComentariosInstrucc() {
        return (String) getAttributeInternal(COMENTARIOSINSTRUCC);
    }

    /**Sets <code>value</code> as attribute value for COMENTARIOS_INSTRUCC using the alias name ComentariosInstrucc
     */
